...
// Alias lambda_details into the xdiag::omp namespace for backwards
// compatibility with existing code that uses omp::lambda_details<...>.
using utils::lambda_details;
